...
# Adapted from GitHub's Awesome-Copilot repo: https://github.com/github/awesome-copilot/blob/main/instructions/code-review-generic.instructions.md
---
...
This instruction set is designed to be flexible and can be customized with project-specific checks, language/framework conventions, and team practices. Use this as a baseline for consistent and effective code reviews across your codebase.

If there are conflicts between this and project-specific instructions, the project-specific instructions should take precedence over just those specific checks, not the entire review process.
